...
- **Smart Raid Organization** - TBC-aware scored raid optimizer with spec prompts, fill simulations, low-move previews, and explanations for caster, melee, threat, mana, and healer groups
...
```
When used outside a raid, Smart Organize opens a simulated raid planning preview instead of trying to move real players. Use Fill 2x, Fill 4x, or Fill 8x to watch a simulated raid fill while Grouper shows the recruitment messages it would advertise.
